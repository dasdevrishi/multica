...
) RETURNING id, workspace_id, title, description, icon, status, lead_type, lead_id, created_at, updated_at, priority, repos, workspace_folder
`
...
type CreateProjectParams struct {
	...
	WorkspaceFolder pgtype.Text `json:"workspace_folder"`
}
...
SELECT id, workspace_id, title, description, icon, status, lead_type, lead_id, created_at, updated_at, priority, repos, workspace_folder FROM project
WHERE id = $1
`
